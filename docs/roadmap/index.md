...
> [!NOTE]
> This roadmap section is a work in progress. The information provided here reflects the current plans and status of VTK WebAssembly features, but is subject to change based on technical considerations, user feedback, and evolving priorities.
